      ...
      <Flex direction="column">
        {completed || !dataCollectionEnabled
          ? (studyConfig.uiConfig.studyEndMsg
            ...
            : <Text size="xl" display="block"><p>Thank you for completing the study.</p><p>If you are from Prolific, your completion code is C15GWY6D. Please copy this code into Prolific as proof of completion.</p><p>You may now close this window.</p></Text>)
          : (
            <>
