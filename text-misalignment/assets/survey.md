...
<li>You will be presented <strong>brief statements</strong> accompanied by <strong>36 charts</strong>.</li>
<li>If the chart is too small or hard to read, you can open a <strong>higher-resolution version</strong> using the <strong>link underneath the image</strong>.</li>
...
<p>When you are ready to continue, <strong>press the "Next" button</strong>. This button is found on the <strong>bottom of the page</strong>.</p>
</div>